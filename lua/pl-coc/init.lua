...
g.coc_global_extensions = {
   ...
   'coc-svg',
   -- 'coc-tailwind-intellisense', https://github.com/iamcco/coc-tailwindcss/issues/64
   'coc-tslint-plugin',
   'coc-tsserver',
   'coc-vetur',
   'coc-vimlsp',
...
local mappings = {
	i = { -- Insert mode
        ...
        {'<C-B>', 'coc#float#has_scroll() ? coc#float#scroll(0) : "<Left>"', { expr = true, silent = true, nowait = true }},
         ...
         {'<CR>',  'pumvisible() ? coc#_select_confirm() : "<C-g>u<CR>"', {expr = true, noremap = true, silent = true}}
	},
	n = { -- Normal mode
        ...
        {'gR', '<Plug>(coc-rename)', { noremap = false }},
